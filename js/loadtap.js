$(function() {
	$.post("json/hotmain.json", function(data) {
		...
		for(var i in data["0"]["0"]) {
			$(".floor1 .product_list").append("<li><a href=''><img src='images/" + data["0"]["0"][i][0] + "'/>" + "<div class='name'>" + data["0"]["0"][i][1] + "</div><div><span class='small'>" + data["0"]["0"][i][2] + "</span><span class='price'>" + data["0"]["0"][i][3] + "</span>" + "</a></li>")
		}
		...
		for(var i in data[a]["0"]) {
			...
			$(b).find(" .product_list").append("<li><a href=''><img src='images/" + data[a]["0"][i][0] + "'/>" + "<div class='name'>" + data[a]["0"][i][1] + "</div><div><span class='small'>" + data[a]["0"][i][2] + "</span><span class='price'>" + data[a]["0"][i][3] + "</span>" + "</a></li>")
		}
		...
		for(var i in data[a]["9"]) {
			$(b).find(" .tabcontent").append("<li><span class='i_yeicon'>" + (Number(i)+1) + "</span><a href='' class='hotbookname text-overflow'>" + data[a]["9"][i][0] + "</a><div class='info'><a><img src='images/" + data[a]["9"][i][1][0] + "'/></a><span class='hotbookprice'>" + data[a]["9"][i][1][2] + "</span><span class='small'>" + data[a]["9"][i][1][3] + "</span><span class='nub'>销售量：<b>" + data[a]["9"][i][1][4] + "</b></span></div></li>")
		}
